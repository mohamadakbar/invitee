...
<main id="main">
    ...
    <!-- ======= Hero Section ======= -->
    <section id="hero" class="d-flex align-items-center" style="background:url( '../upload_img/cover.png' );background-repeat: no-repeat;background-attachment: fixed;background-size: 10% 20%; background-position: center; background-repeat: no-repeat; background-size: cover; object-fit: fill; object-position: 20% 10%; ">
...
{{--                    </div>--}}
                    <div class="form-group text-center mt-2">
                        <a href="https://goo.gl/maps/UASLE4gEp2rwsvJA8" target="_blank" style="background: #00506a;border: 0;padding: 10px 35px;color: #fff;transition: 0.4s;border-radius: 50px; font-size: 17px" class="btn-sm mt-3">Lihat lokasi</a>
                    </div>
